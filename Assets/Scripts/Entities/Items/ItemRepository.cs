...
public class ItemRepository
{
    ...
    public ItemRepository()
    {
        ...
        specialItems = new List<Item>()
        {
            ...
            new Weapon(name:"Cherubic Light", description:"The holy magical energy that forms Cherub's halo can be compressed into powerful beams of light.", cost:4, graphic:0, damage:7, range:8, accuracyModifier: 1f, omniWeapon:true, magicWeapon: true, lockedItem:true),
